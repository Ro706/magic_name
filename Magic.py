...
if swt2=="on":
 print("Sorry "+str(name)+",I had to skip number/n.")
 
if swt1=="on":
 print("Sorry "+str(name)+",I had to skip spacial charecter/n.")
 
if swt=="on":
 print("Sorry "+str(name)+",you used unknown letter/n so I skipped it.")
 
 
#Asking user for feedback
print("Thanks "+str(name)+" from Ro706.If any fault then comment.")
